...
# (translatable)
CONTENT_FOOTER = 'Contact: <a href="mailto:{email}">{author}</a> | <a href="/about/">About our effort</a> | Website source <a href="https://github.com/reprozip-news-apps/website">github.com/reprozip-news-apps/website</a>'
